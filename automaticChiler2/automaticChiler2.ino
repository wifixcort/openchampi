...
void setup() {
  ...
  dbg.begin(9600);
  dbg.println("Serial Ready...");
  RS485Serial.begin(19200);
  dbg.println("Serial 1 Ready...");
...
void serialEvent(){
  ...
  while(RS485Serial.available()) { //Look for data from other Arduino
   ...
   if (RS485Serial.available()){  //Look for data from other Arduino
     ...
     chillerBuff[i] = byteReceived;
     i++;
      //dbg.print(byteReceived, HEX);        // Show on Serial Monitor
      //dbg.print("+");
     //delay(20);
